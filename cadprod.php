...
if ($session_tipo == 'Vendedor'){
    if (isset($_FILES['img-pd'])){
        ...
        if(mysqli_query($conn, $sql)){
            echo"<script language='javascript' type='text/javascript'>alert('A imagem foi salva na base de dados.');window.location.href='vendedor.php'</script>";
        }else{
            echo"<script language='javascript' type='text/javascript'>alert('Não foi possível salvar as informações.');window.location.href='cadprod.html'</script>";
        }
    } else{
